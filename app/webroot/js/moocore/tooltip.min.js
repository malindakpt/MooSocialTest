(function(a,b){"function"===typeof define&&define.amd?define(["jquery","mooPhrase","qtip"],b):"object"===typeof exports?module.exports=b(require("jquery")):a.mooTooltip=b()})(this,function(a,b){return{init:function(){0!=a("#page_share-ajax_share").length||1!=mooConfig.profile_popup||mooConfig.isMobile||a(".moocore_tooltip_link").qtip({content:{text:function(e,d){var c=a(this).data();a.post(mooConfig.url.base+"/activities/ajax_load_tooltip",{item_id:c.item_id,item_type:c.item_type},function(c){d.set("content.text",
c);a(".response_friend_request").length&&(a(".response_friend_request").unbind("click"),a(".response_friend_request").on("click",function(){a(".response_request").show()}));a(".respondRequest").length&&(a(".respondRequest").unbind("click"),a(".respondRequest").on("click",function(){var b=a(this).data();a.post(mooConfig.url.base+"/friends/ajax_respond",{id:b.id,status:b.status},function(a){location.reload()})}));a(".usertip_action_follow").unbind("click");a(".usertip_action_follow").click(function(){element=
...
my:"top left",at:"right center",adjust:{y:0},viewport:a(window)},style:{}})}}});