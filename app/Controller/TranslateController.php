...
class TranslateController extends AppController {
	...
	{
		$values = $this->loadPo('D:\wamp\www\Git\2.3.2\app\Locale\eng\LC_MESSAGES\default.pot');
		$values1 = $this->loadPo('D:\wamp\www\Git\2.3.2\app\Locale\eng\LC_MESSAGES\default.po');	
