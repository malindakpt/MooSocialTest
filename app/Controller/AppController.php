...
class AppController extends Controller
{
    ...
    */
     ...
     */
    protected function _checkPrivacy($privacy, $owner, $areFriends = null, $redirect = true)
    {
        $uid = $this->Auth->user('id');
        if ($uid == $owner) // owner
        {
    ...
    public function getDescriptionForMeta($description)
    {
    	...
    	return $helper->convertDescriptionMeta(trim(String::truncate($description,2000, array('ellipsis' => '', 'html' => false, 'exact' => false))));
    }
