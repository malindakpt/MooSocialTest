<div>
    <div class="tooltip_main">
        ...
        <div class="item_geneal_info">
            ...
            <?php if($type == 'User'): ?>
                <div class="item_stat extra_info"><span class="date"><?php echo __('Gender')?>:</span> <?php $this->Moo->getGenderTxt($object['User']['gender']); ?></div>
                <?php if ( !empty( $object['User']['birthday'] ) && $object['User']['birthday'] != '0000-00-00'): ?>
