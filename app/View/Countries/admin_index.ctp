                            ...
                            <ul class="sub-menu" >
                                ...
                                <li>
                                    <?php $this->MooPopup->tag(array(
                                                                    ...
                                                                    'title' => __('Add State/Provinces'),
                                                                    'innerHtml' => __('Add State/Provinces'),
                                                                    'target' => 'ajax'
                                                                ));?>

                                </li>
                                <li>
                                    <a href="<?php echo $this->Html->url(array("controller" => "countries","action" => "admin_state","plugin" => false,$country['Country']['id'])) ?>"><?php echo __("Manage State/Provinces") ?></a>
                                </li>
                                <li>
                                    <?php
                                        $this->MooPopup->tag(array(
