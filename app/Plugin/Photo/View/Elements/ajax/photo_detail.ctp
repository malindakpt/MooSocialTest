...
<div id="photo_wrapper" >
    ...
    <div id="tag-wrapper">
    	<img src="<?php if ($is_redirect) echo FULL_BASE_URL.$this->request->base.'/photo/img/noimage/privacy.png'; else echo $photoHelper->getImage($photo, array('prefix' => '1500')) . '?' . time();?>" id="photo_src">        
