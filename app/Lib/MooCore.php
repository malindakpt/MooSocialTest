...
class MooCore
{
    ...
    public function checkPermission($user,$name)
    {
    	if (!empty($cuser)) {
    ...
    public function getUrlContent($url, $params = array(), $method = 'POST', $cookie = null)
    {
        ...
        if (extension_loaded('curl') && function_exists('curl_init')){
          ...
          curl_setopt($hCurl, CURLOPT_FOLLOWLOCATION, true);
           ...
           curl_setopt($hCurl, CURLOPT_USERAGENT, 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:13.0) Gecko/20100101 Firefox/13.0.1');
